...
import ss8.security.security.jwt.JwtEntryPoint;
import ss8.security.security.jwt.JwtTokenFilter;
import ss8.security.security.principal.UserDetailService;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().configurationSource(request -> {
            ...
            return cfg;
                ...
                .authorizeRequests()
                .antMatchers("/api/v4/auth/**").permitAll() // cho phép truy cập ko cần xác thực
